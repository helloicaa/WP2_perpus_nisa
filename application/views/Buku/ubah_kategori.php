    ...
    <div class="row">
        <div class="col-lg-6">
            <?php if (validation_errors()) {
              ...
              class="alert alert-danger alert-message" role="alert">Nama Kategori Tidak Boleh Kosong!!</div>');
            ...
            <?php foreach ($kategori as $k) { ?>
                <form action="<?= base_url('Buku/ubahKategori'); ?>" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-user" id="kategori" placeholder="Masukan Kategori Buku" value="<?php echo $k['kategori']; ?>">
                    </div>
                    <div class="form-group">
